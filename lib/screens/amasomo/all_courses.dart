...
import 'package:rwanda_traffic_rules/screens/amasomo/course_contents.dart';
          ...
          actions: [
            if (userRole == "Admin")
              IconButton(
                ...
                onPressed: () {
                  // Show interstitial ad for course management
            ...
            Container(
              ...
              child: GestureDetector(
                ...
                child: Row(
                  children: [
                    Icon(Icons.rule_rounded, color: Colors.white, size: 16),
