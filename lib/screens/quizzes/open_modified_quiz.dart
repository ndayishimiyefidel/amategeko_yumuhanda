import 'dart:async';
import 'dart:convert';
import 'package:rwanda_traffic_rules/screens/questions/edit_quiz_question.dart';
...
import 'package:rwanda_traffic_rules/enume/models/question_model.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:rwanda_traffic_rules/screens/quizzes/result_screen.dart';
    ...
    return GestureDetector(
      ...
      onTap: () {
        ...
        GenerateUser.deleteUserCode(context, widget.questionModel.id.toString(),
            "1", deleteApiUrl, "quiz 1", "question deleted successfully");
      },
    );
  }
